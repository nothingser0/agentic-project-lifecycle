...
| `none` | Large | Apply ask-twice policy with risk confirmation per PROJECT-PROFILE.md (or Block if handling regulated data / compliance override: no skip option): Prompt 1 warns of contract/interface breakage; Prompt 2 requires explicit confirmation ("I accept the risk of architecture rework and scope drift") before proceeding to BUILD |
