...
| **P2 Medium** | Minor feature broken, 5xx 1–5% | CSV export fails, filter broken | ≤ 4 hours | ≤ 1 week | Normal PR flow (next regular release) |
| **P3 Low** | Cosmetic, typo, minor UX, 5xx < 1% | Button text wrong, color off | ≤ 1 business day | ≤ 2 weeks | Backlog |
