...
| legal | `closure_date`, `bast_signed_by`, `legal_reviewed_by`, `access_revoked: true` |
...
- Large+: `OWNERSHIP.md` is required only when `multi_agent: true`; the contracts and ADR directories are scaffolded for those tiers.
